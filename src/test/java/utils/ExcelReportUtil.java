...
public class ExcelReportUtil {
    private static final String EXCEL_PATH = "src/test/resouces/data/TestResults.xlsx";
...
//    cái nào xong trước thì đọc file để cập nhật status trước
    public static synchronized void updateStatus(String featureName, String testCaseName, String status) {
